setwd("/restricted/projectnb/ptsd/hbayly/Temp_Thesis/")
...
PARAMS <- list(
  seeds = 1:100,
  #models = c("xgboost", "glm"),
  models = c("xgboost"),
  p_vals = c(100),
  n_train = 1000,
  n_test = 500,
  corr_types = c("identity","toeplitz","block"),
  rhos = c(0.3),
...
# save results
saveRDS(results_dt, "/restricted/projectnb/ptsd/hbayly/Temp_Thesis/SimulationResults/Correlation_Type_ProjectOne_Simulation.rds")
